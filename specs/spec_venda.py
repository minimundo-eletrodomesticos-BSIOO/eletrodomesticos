...
class Test_Venda_Spec(unittest.TestCase):
	...
	def test_esta_na_garantia(self):
		venda = Venda("Ela", "Casa dela","Samsung Galaxy", "SAMSUNG", "I8150", "26/10/2012")
		venda.fazer_venda()
		venda.lista_vendas_1[0].nome_cli |should| equal_to("Ela")
		venda.lista_vendas_1[0].descricao_prod |should| equal_to('Samsung Galaxy')
		venda.consultar_garantia("26/11/2012") |should| equal_to("Ainda está na garantia!")

	def test_esta_fora_da_garantia(self):
		venda = Venda("Ela", "Casa dela","Samsung Galaxy", "SAMSUNG", "I8150", "26/10/2012")
		venda.consultar_garantia("26/10/2013") |should| equal_to("Ainda está na garantia!")
